		...
		$output =
			...
			$this->_classMethod(
				...
				array(
					...
					'$blockId = \'2\';',
					'$blockKey = \'block_1\';',
					'if ($contentKey === \'' . $this->pluginSingularizeUnderscore . '_content_key_2\') { //TODO:keyをセットする',
					chr(9) . '$contentId = \'3\'; //TODO:idをセットする',
					'} elseif ($contentKey === \'' . $this->pluginSingularizeUnderscore . '_content_key_4\') { //TODO:keyをセットする',
					chr(9) . '$contentId = \'5\'; //TODO:idをセットする',
					'} else {',
			...
			$this->_classMethod(
				...
				array(
					...
					'));',
					'// ** 自分の記事＆一度公開している',
					'$contentKey = \'' . $this->pluginSingularizeUnderscore . '_content_key_4\'; //TODO:keyをセットする',
					'array_push($results, array(',
					chr(9) . '\'data\' => $this->__data($contentKey),',
					chr(9) . '\'role\' => Role::ROOM_ROLE_KEY_GENERAL_USER,',
					chr(9) . '\'urlOptions\' => array(',
