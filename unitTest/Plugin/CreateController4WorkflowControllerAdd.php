		...
		$output =
			...
			$this->_classMethod(
				...
				array(
					...
					'//テストデータ',
					'$results = array();',
					'$results[0] = Hash::merge($result, array(',
			...
			$this->_classMethod(
				...
				array(
					...
					');',
					'$this->assertInput(',
					chr(9) . '\'button\', \'save_\' . WorkflowComponent::STATUS_IN_DRAFT, null, $this->view',
					');',
					'$this->assertInput(',
					chr(9) . '\'button\', \'save_\' . WorkflowComponent::STATUS_APPROVED, null, $this->view',
					');',
					'',
			...
			$this->_classMethod(
				...
				array(
					...
					');',
					'$this->assertInput(',
					chr(9) . '\'button\', \'save_\' . WorkflowComponent::STATUS_PUBLISHED, null, $this->view',
					');',
					'',
					'//TODO:上記以外に必要なassert追加',
					'',
